...
(function($) {
    ...
    $.fn.timepicker = function(options) {
        ...
        var debug = false,
            ...
            _clearText = 'Borrar', // Display text for clear link
            _closeWrapClass = 'close-wrap',
            _closeText = 'Aceptar', // Display text for close link
            _suggestNowText = 'Ahora', // Display text for Now
            _suggestTimeNames = {
                _suggestNowText:          null,    // Calculate when needed
                '6 a.m.':        [6, 0, 0],
                'Mediodia':      [12, 0, 0],
                '8 p.m.':        [20, 0, 0],
                'Medianoche':    [0, 0, 0]
        ...
        var _html = '<div id="' + _mainWrapper + '" class="hidden"><table><tbody><tr class="'
                  ...
                  + '"><td colspan="5">'+_suggestNowText+'</td></tr><tr class="' + _timeSuggestWrapClass
                  + '"><td colspan="5">6 a.m.</td></tr><tr class="' + _timeSuggestWrapClass
                  + '"><td colspan="5">Mediodia</td></tr><tr class="' + _timeSuggestWrapClass
                  + '"><td colspan="5">8 p.m.</td></tr><tr class="' + _timeSuggestWrapClass
                  + '"><td colspan="5">Medianoche</td></tr><tr class="' + _buttonWrapClass
        ...
        */ 
		this.click(showTimepicker).keydown(doKeyDown);
		//this.focus(showTimepicker);//cuando se vuelve a abrir se aparece como si nada
        ...
        function hideTimepicker() {
            if (_timepickerShowing) {
				...
				//$('fieldset table').addClass('hidden');
