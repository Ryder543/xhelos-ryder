...
class regionsresources extends identities { //[TODO]Deberiamos de instanciarlo de una interface objeto 
...
//////////////////////////////////////////////////////////////////////////////////
    ...
    public function __construct() {
        $args = func_get_args();
        if (!empty($args)) {
            debug::error('regionsresources se inicio con argumentos', 'regionsresources->constructor');
        }
        parent::__construct('regionresourceman'); //CARAJOOOO
    }
...
//////////////////////////////////////////////////////////////////////////////////
    public function initAll() {
        $sql = "select * from regions_resources";
    ...
    public function initAllActive() {
        $sql = "select * from regions_resources WHERE status = '" . _X_ACTIVE . "'";
        $resources = $this->db->vectorize($sql);
        $this->setRaw($resources);
        return $this->getRaw();
    }
    ...
    public function initActiveByRegion($regionId) {
        $sql = "select * from regions_resources WHERE status = '" . _X_ACTIVE . "' AND region_id = ".$regionId;
        $resources = $this->db->vectorize($sql);
        $this->setRaw($resources);
        return $this->getRaw();
    }   
