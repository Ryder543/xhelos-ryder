...
<div id="Header">
  <div id="DataCenter" class="ui-state-hover">
     <div id="ExtractedRes" class="ui-state-active">
        <ul>
          <li id="Res6W"><span  id="Res6"></span><img src="img/web/icon_res6.png" alt="Biomateria"></li>
          <li id="Res7W"><span  id="Res7"></span><img src="img/web/icon_res7.png" alt="Agua"></li>
          <li id="Res8W"><span  id="Res8"></span><img src="img/web/icon_res8.png" alt="Crecimiento"></li>
        </ul>
     </div>
    ...
    <div id="PlayerInfo" class="ui-state-active">
     ...
     <div id="NormalRes" class="ui-state-active ui-helper-clearfix">
        <ul>
          <li id="Res1W"><span  id="Res1"></span> <img src="img/web/icon_res1.png" alt="Cristales de Fuego"></li>
          <li id="Res2W"><span  id="Res2"></span> <img src="img/web/icon_res2.png" alt="Sal de Energia"></li>
          <li id="Res3W"><span  id="Res3"></span> <img src="img/web/icon_res3.png" alt="Extracto de Oceano"></li>
          <li id="Res4W"><span  id="Res4"></span> <img src="img/web/icon_res4.png" alt="Bio Constructores"></li>
          <li id="Res5W"><span  id="Res5"></span> <img src="img/web/icon_res5.png" alt="Pirita Volcanica"></li>
        </ul>
     </div>
  </div>
  ...
  <div id="SubMenu-Container" class="ui-helper-clearfix">
    <ul id="SubMenu-Navigation" class="submenu ui-helper-clearfix <?php echo $menu->sub_nav_hidden;?>">
      ...
      <li class="<?php echo $menu->getPageState('star') ?>"><?php echo ($menu->isStarSet()) ? "<a href='"._X_FILE_STAR."?star_id=".$menu->getStarId()."'>" : '' ?><img src="img/web/submenu_solar.png"><span class='title'><?php echo ($menu->isStarSet()) ? $menu->getStarName() : 'Seleccione ' ?></span><span class='subtitle'>Estrella</span><?php echo ($menu->isStarSet()) ? "</a>" : '' ?></li>
      <li class="<?php echo $menu->getPageState('planet') ?>"><?php echo ($menu->isPlanetSet()) ? "<a href='"._X_FILE_PLANET."?planet_id=".$menu->getPlanetId()."'>" : '' ?><img src="img/web/submenu_planet.png"><span class='title'><?php echo ($menu->isPlanetSet()) ? $menu->getPlanetName() : 'Seleccione ' ?></span><span class='subtitle'>Planeta</span><?php echo ($menu->isPlanetSet()) ? "</a>" : '' ?></li>
      <li class="extra <?php echo $menu->getPageState('region') ?>"><?php echo ($menu->isRegionSet()) ? "<a href='"._X_FILE_REGION."?region_id=".$menu->getRegionId()."'>" : '' ?><img src="img/web/submenu_region.png"><span class='title'><?php echo ($menu->isRegionSet()) ? $menu->getRegionName() : 'Seleccione ' ?></span><span class='subtitle'>Region</span><?php echo ($menu->isRegionSet()  ) ? "</a>" : '' ?></li>
      <li class="extra <?php echo $menu->getPageState('colony')  ?>"><?php echo ($menu->isColonySet()) ? "<a href='"._X_FILE_COLONY."?colony_id=".$menu->getColonyId()."'>" : '' ?><img src="img/web/submenu_colony.png"><span class='title'><?php echo ($menu->isColonySet()) ? $menu->getColonyName() : 'Seleccione ' ?></span><span class='subtitle'>Colonia</span><?php echo ($menu->isColonySet()) ? "</a>" : '' ?></li>
