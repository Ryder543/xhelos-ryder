<?php
// $Id: advf-forum-list.tpl.php,v 1.1 2009/07/15 00:57:54 eigentor Exp $
 ...
 */
 /*Special Case: If Forum Deep is 0 then dont show the header */
 if($forum_id==0){
   $colspan = ' colspan="5" ';
 }else{
   $colspan = '';
...
<table id="forum-<?php print $forum_id; ?>" class="forum-table forums-overview">

  <thead class="forum-header">
    <tr>
      <th  <?php echo $colspan ?> class="forum-icon"></th>
      <?php if($forum_id!=0){ ?>
