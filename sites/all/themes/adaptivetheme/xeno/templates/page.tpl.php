 ...
 * - $cuaternary_content: Ful width at the bottom of the ternary content
 *
 * Footer/closing data:
...
<body class="<?php print $classes; ?>">
  <div id="container">
    ...
    <?php if ($leaderboard): ?>
      <div id="leaderboard"><?php print $leaderboard; ?><div class="clear">.</div></div> <!-- /leaderboard -->
    <?php endif; ?>
    ...
    <?php if ($tertiary_content): ?>
      <div id="tertiary-content"><?php print $tertiary_content; ?><div class="clear">.</div></div> <!-- /tertiary-content -->
    <?php endif; ?>

    <?php if ($cuaternary_content): ?>
      <div id="cuaternary-content"><?php print $cuaternary_content; ?><div class="clear">.</div></div> <!-- /cuaternary_content -->
    <?php endif; ?>
